...
truth_df$class <- with(truth_df, ifelse(mu_grid == 0.5 & !sex_flag, "C1_balanced_no_sex",
                                 ifelse(mu_grid == 0.5 & sex_flag, "C2_balanced_sex_only",
                                 ifelse(mu_grid != 0.5 & !sex_flag, "C3_imbalanced_no_sex",
