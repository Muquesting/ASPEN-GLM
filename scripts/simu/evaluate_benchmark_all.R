...
methods <- list(
  ...
  list(name = "scDALI", dir_pattern = "scdali", padj_col = "padj", file = "scdali_hom_results.csv", pval_col = "pvalues")
)
...
ggsave(file.path(out_dir, "plots", "f1_by_category.png"), p_tpr, width = 12, height = 6)
