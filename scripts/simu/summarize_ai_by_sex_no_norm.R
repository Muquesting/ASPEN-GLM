...
PIPELINES <- list(
  list(
    ...
    rel_path = file.path("glmmtmb_glmmtmb_betabin", "SimCell", "SimCondition", "phi_glm_results.csv"),
    padj_col = "padj_intercept"
  ),
  list(
    name = "GAMLSS Beta-Binomial",
    rel_path = file.path("gamlss_gamlss_betabin", "SimCell", "SimCondition", "phi_glm_results.csv"),
    padj_col = "padj_intercept"
  ),
  list(
    name = "GLM Dispersion (Raw)",
    rel_path = file.path("glm_raw_rawdisp", "SimCell", "SimCondition", "phi_glm_results.csv"),
    padj_col = "padj_intercept"
  ),
  list(
    name = "Shrinkage GLM Dispersion",
    rel_path = file.path("glm_shrink_allcells_withsex_noimp", "SimCell", "SimCondition", "phi_glm_results.csv"),
    padj_col = "padj_intercept"
  ),
  list(
    name = "GLM-Mapping-BB",
    rel_path = file.path("glmmtmb_v_allcells_withsex_noimp", "SimCell", "SimCondition", "phi_glm_results.csv"),
    padj_col = "padj_intercept"
  ),
  list(
    name = "ASPEN",
    rel_path = file.path("aspen_allcells_withsex_noimp", "SimCell", "SimCondition", "bb_mean_results.csv"),
    padj_col = "padj_mean"
  ),
  list(
    name = "scDALI",
